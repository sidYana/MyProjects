...
public class NeuralNetwork implements Serializable {
	...
	public NeuralNetwork(List<FloatMatrix> newNetworkWeights) {
		networkWeights=newNetworkWeights;
	}
	...
	public float[] predict(float[] inputs) {
		...
		for(int count = 0; count < networkWeights.size(); count++) {
	...
	public List<FloatMatrix> getWeights(){
